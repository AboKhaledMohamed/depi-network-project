...
header shell information "*** Core Switch HQ1 - Unauthorized Access Prohibited ***"
...
interface Eth-Trunk1
 description Link to LSW4 Standby
 port link-type trunk
 port trunk allow-pass vlan 10 20 30 40 50
 mode lacp

interface GigabitEthernet0/0/2
 description Trunk Member to LSW4
 eth-trunk 1
